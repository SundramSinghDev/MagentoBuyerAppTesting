 ...
 *
 */
package com.magentotwo.magenativeapp.base.activity;
...
import com.magentotwo.magenativeapp.Ced_MageNative_FontSetting.Ced_FontSetting;
...
import com.magentotwo.magenativeapp.Ced_MageNative_SharedPrefrence.Ced_SessionManagement_login;
import com.magentotwo.magenativeapp.R;
import com.magentotwo.magenativeapp.base.fragment.BaseFragment;
import com.magentotwo.magenativeapp.base.fragment.Ced_FragmentDrawer;
import com.magentotwo.magenativeapp.base.viewmodel.NavDrawerViewModel;
import com.magentotwo.magenativeapp.databinding.MagenativeNavMainBinding;
import com.magentotwo.magenativeapp.databinding.WebviewBinding;
...
import com.magentotwo.magenativeapp.ui.checkoutsection.activity.BillingShippingAddress;
import com.magentotwo.magenativeapp.ui.checkoutsection.activity.ShippingMethodList;
import com.magentotwo.magenativeapp.ui.homesection.activity.Ced_Categories;
import com.magentotwo.magenativeapp.ui.loginsection.activity.Ced_Login;
import com.magentotwo.magenativeapp.ui.networkhandlea_activities.Ced_ConnectionDetector;
import com.magentotwo.magenativeapp.ui.networkhandlea_activities.Ced_NoInternetconnection;
import com.magentotwo.magenativeapp.ui.newhomesection.activity.Magenative_HomePageNewTheme;
import com.magentotwo.magenativeapp.ui.notificationactivity.activity.Ced_NotificationList;
import com.magentotwo.magenativeapp.ui.profilesection.activity.Ced_AccountDashboard;
import com.magentotwo.magenativeapp.ui.searchsection.activity.Ced_Searchview;
import com.magentotwo.magenativeapp.ui.websection.Ced_Weblink;
import com.magentotwo.magenativeapp.ui.wishlistsection.activity.Ced_WishListing;
        ...
        navBinding.toolimage.setOnClickListener(v -> {
            try {
                ...
                for (ActivityManager.RunningTaskInfo aTask : alltasks) {
                    if (!(Objects.requireNonNull(aTask.topActivity).getClassName().equals("com.magentotwo.magenativeapp.ui.homesection.activity.Ced_New_home_page"))) {
...
//        drawerFragment.setDrawerListener(this);
    ...
    public void hide_bottom_navigation() {
...
//                            intent.putExtra("link", finalNewurl);
    ...
    public void show_WebViewSetting_inparent(LinearLayout parent, String datatoshow) {
        ...
        String text = "<html><style type='text/css'>@font-face { font-family: spqr; src: url('fonts/Celias-Regular.ttf'); } body p {color: #a9a9a9;font-family: spqr; font-size: 50px;}</style>"
                + "<body >" + "<p align=justify style=font-size: 50px; font-family: spqr; color: #a9a9a9;>" +  datatoshow+ "</p> "+ "</body></html>";
