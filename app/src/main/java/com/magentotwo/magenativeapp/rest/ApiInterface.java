package com.magentotwo.magenativeapp.rest;
...
//----------------
    @POST(Urls.GET_SHIPPING_METHODS)
    Call<Object> getShippingMethods(@Body JsonObject postData);

    @POST(Urls.SAVE_SHIPPING_METHODS)
    Call<Object> saveShippingMethods(@Body JsonObject postData);

    @POST(Urls.PREPARE_SHIPPING_METHODS)
    Call<Object> prepareShippingMethod(@Body JsonObject postData);

    @POST(Urls.GET_PAYMENT_METHODS)
    Call<Object> getPaymentMethods(@Body JsonObject postData);

    @POST(Urls.SAVE_PAYMENT_METHODS)
    Call<Object> savePaymentMethods(@Body JsonObject postData);
//-------------
