...
package com.magentotwo.magenativeapp.ui.addresssection.activity;
...
import com.magentotwo.magenativeapp.databinding.MagenativeAddCustomerAddressPageBinding;
            ...
            if (firstname.length() == 0) {
                ...
                try {
                  ...
                  /*  if (dobflag) {
                    ...
                    if ( addressPageBinding.stateLayout.getVisibility()==View.VISIBLE)
                    {
                    ...
                    try {
                        ...
                        if (object.getBoolean("success")) {
                            ...
                            else
                            {
                                ...
                                addressPageBinding.stateDropdownLayout.setVisibility(View.GONE);

                                edt_state.setVisibility(View.VISIBLE);
                                addressPageBinding.stateLayout.setVisibility(View.VISIBLE);
        ...
        try {
            ...
            if (jsonObj.has("header") && jsonObj.getString("header").equals("false")) {
                ...
                if (status.equals("success")) {
                    ...
                    {
                        addresslistingintent = new Intent(getApplicationContext(), Ced_Addressbook.class);
                    }
