...
public class Ced_UpdateAddressbook extends Ced_NavigationActivity {
    ...
    String Email, firstname, lastname, Street, City,  Pincode, Country, Mobile, id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_savedetail.setOnClickListener(v -> {
            ...
            if (firstname.length() == 0) {
            ...
            } else if (edt_state.getText().toString().length() == 0 && state_dropdown.getText().toString().length() == 0) {
                ...
                try {
                    ...
                    if (state_layout.getVisibility()==View.VISIBLE)
                    {
                        ...
                        {
                            hashMap.addProperty("region", edt_state.getText().toString());
                        }
