...
import com.magentotwo.magenativeapp.ui.addresssection.activity.Ced_AddAddress;
...
import com.magentotwo.magenativeapp.databinding.ActivityBillingShippingAddressBinding;
import com.magentotwo.magenativeapp.databinding.MagenativeAddressListItemShippingBinding;
                                            ...
                                            if (addressBinding.country.getText().toString().isEmpty()) {
                                                ...
                                                if (statedropdown) {
                                                    if (addressBinding.regionId.getText().toString().isEmpty()) {
                                                        ...
                                                        JsonObject billingaddressparam = new JsonObject();
                                                        try {
                                                            if (prefixflag) {
                                                                if (prefixvalue.isEmpty()) {
                                                                   ...
                                                                   showmsg(getResources().getString(R.string.selectsomeprefixvalue));
                                                                    ...
                                                                    flag = true;
                                                                    billingaddressparam.addProperty(addressBinding.prefixname.getText().toString(), prefixvalue);
                                                                }
                                                            }
                                                            if (middlenamevatflag) {
                                                                if (flag) {
                                                                    if (addressBinding.middlename.getText().toString().isEmpty()) {
                                                                        ...
                                                                        flag = true;
                                                                        billingaddressparam.addProperty(addressBinding.middlename.getTag().toString(), addressBinding.middlename.getText().toString());
                                                                    }
                                                                }
                                                            }
                                                            if (suffixflag) {
                                                                if (flag) {
                                                                    if (suffixvalue.isEmpty()) {
                                                                        ...
                                                                        flag = true;
                                                                        billingaddressparam.addProperty(addressBinding.suffixname.getText().toString(), suffixvalue);
                                                                    }
                                                                }
                                                            ...
                                                            if (taxvatflag) {
                                                                if (flag) {
                                                                   /* if(MageNative_taxvat.getText().toString().isEmpty())
                                                                    ...
                                                                    {
                                                                        flag=true;*/
                                                                    billingaddressparam.addProperty(addressBinding.taxvatname.getText().toString(), addressBinding.MageNativeTaxvat.getText().toString());
                                                                    /* }*/
                                                                }
                                                            }
                                                            ...
                                                            billingaddressparam.addProperty("firstname", addressBinding.firstname.getText().toString());
                                                            billingaddressparam.addProperty("lastname", addressBinding.lastname.getText().toString());
                                                            billingaddressparam.addProperty("street", addressBinding.street.getText().toString());
                                                            billingaddressparam.addProperty("city", addressBinding.city.getText().toString());
                                                            billingaddressparam.addProperty("region_id", statelabel_id.get(addressBinding.regionId.getText().toString()));
                                                            billingaddressparam.addProperty("region", " ");
                                                            billingaddressparam.addProperty("postcode", addressBinding.zipcode.getText().toString());
                                                            billingaddressparam.addProperty("country_id", countrylabel_code.get(addressBinding.country.getText().toString()));
                                                            billingaddressparam.addProperty("telephone", addressBinding.phonenumber.getText().toString());
                                                            billingaddressparam.addProperty("fax", " ");

                                                            shippingmethoddata.addProperty("billingaddress", billingaddressparam.toString());
                                                        }
                                                        catch (Exception e) {
                                                            e.printStackTrace();
                                                        }
                                                    ...
                                                    if (addressBinding.region.getText().toString().isEmpty()) {
                                                        ...
                                                        try {
                                                            ...
                                                            billingaddressparam.addProperty("street", addressBinding.street.getText().toString());
                                                            billingaddressparam.addProperty("city", addressBinding.city.getText().toString());
                                                            // billingaddressparam.put("region_id"," ");
                                                            billingaddressparam.addProperty("region", addressBinding.region.getText().toString());
                                                            billingaddressparam.addProperty("postcode", addressBinding.zipcode.getText().toString());
                                                            billingaddressparam.addProperty("country_id", countrylabel_code.get(addressBinding.country.getText().toString()));
                                                            billingaddressparam.addProperty("telephone", addressBinding.phonenumber.getText().toString());
                                                            billingaddressparam.addProperty("email", addressBinding.email.getText().toString());
                                                            billingaddressparam.addProperty("fax", " ");
    ...
    private void Processdata(String s){
        try {
            ...
            if (success.equals("true")) {
                ...
                {
                    intent = new Intent(getApplicationContext(), PayMentMethodList.class);
                }else {
                    intent = new Intent(getApplicationContext(), ShippingMethodList.class);
                }
                        ...
                        try {
                            ...
                            if (status.equals(true)) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    statelabel_id.put(c.getString("default_name"), c.getString("region_id"));
                                    statelabel_code.put(c.getString("default_name"), c.getString("code"));
