...
package com.magentotwo.magenativeapp.ui.notificationactivity;
...
public class MageNative_MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onNewToken(String s) {
      ...
      /*  FirebaseMessaging.getInstance().setAutoInitEnabled(true);*/
        FirebaseMessaging.getInstance().subscribeToTopic("com.magentotwo.magenativeapp").addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
