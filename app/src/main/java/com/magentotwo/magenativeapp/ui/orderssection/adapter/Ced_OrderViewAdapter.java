...
package com.magentotwo.magenativeapp.ui.orderssection.adapter;
...
import com.magentotwo.magenativeapp.databinding.MagenativeOrderplacedListBinding;
    ...
    public void onBindViewHolder(@NonNull Ced_OrderViewAdapter.OrderViewHolder holder, int position) {
        ...
        if (holder.listBinding.MageNativeProdType.getText().toString().equals("configurable") ||
            ...
            while (iterator.hasNext()) {
                ...
                ((Ced_NavigationActivity)act).set_bold_font_fortext(label);
                label.setTextColor(act.getResources().getColor(R.color.onwhitetextcolor));
                label.setText(value);
                ...
                if(!key.equalsIgnoreCase(value))
                {
                    ...
                    optionvalue.setTextColor(act.getResources().getColor(R.color.onwhitetextcolor));
