...
import com.magentotwo.magenativeapp.databinding.MagenativeNewProfilePageBinding;
...
import static com.magentotwo.magenativeapp.Ced_MageNative_SharedPrefrence.Ced_SessionManagement_login.Key_Email;
        ...
        if (session.isLoggedIn()) {
            ...
            update_profile.setOnClickListener(v -> {
                try {
                    ...
                    if (flag) {
                        profileViewModel.getProfileUpdateData(Ced_User_Profile.this, hashMap,session.getHahkey())
