...
public class Urls {
    ...
    public static final String BASE_URL = "https://demo2.cedcommerce.com/m2.4/vendor-app/";
  /*  public static final String BASE_URL = "http://demo2.cedcommerce.com/magento/magenative/pub/";*/
  ...
  /*  public static final String GET_METHODS = "rest/V1/mobiconnect/checkout/getshippingpayament";
    ...
    //Shipping
    public static final String GET_SHIPPING_METHODS = "rest/V1/mobiconnect/checkout/getShippingMethods";
    public static final String SAVE_SHIPPING_METHODS = "rest/V1/mobiconnect/checkout/saveShippingMethod";
    public static final String PREPARE_SHIPPING_METHODS = "rest/V1/prepareshippingmethod";

    // Payment
    public static final String GET_PAYMENT_METHODS = "rest/V1/mobiconnect/checkout/getPayamentMethod";
    public static final String SAVE_PAYMENT_METHODS = "rest/V1/mobiconnect/checkout/savePayamentMethod";
